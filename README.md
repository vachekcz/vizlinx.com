...
Skener respektuje robots.txt pro `VizlinxBot`, čte HTML do 2 MiB a neposílá cookies. Přesměrování stránky na jinou cestu stejného originu (stejný protokol, hostitel a port) automaticky zařadí do fronty. Každý krok podléhá rychlosti, robots i limitu 100 URL; již známá URL se znovu nestahuje. Změnu domény, subdomény, protokolu nebo portu nenásleduje a cílovou adresu ukáže v logu a podrobnostech výsledků. To platí i pro přesměrování na další již přidaný web. Běžné externí HTML odkazy se zobrazí v mapě, ale neprocházejí se bez přidání originu. Mapa uchovává výsledky 30 dní od založení a patří anonymní relaci stejného prohlížeče. Samotné předání URL nezpřístupní mapu jiným lidem.
