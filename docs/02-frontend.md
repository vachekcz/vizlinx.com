...
- **Detail ve variantě 2:** na mapě se otevírá těsně napravo od seznamu webů, s horní hranou zarovnanou k panelu. Šipka ukazuje na viditelný vybraný řádek a sleduje změny jeho výšky i posun seznamu. Navazující detaily webu, stránky a propojení zůstávají na stejném místě. Na mobilu se detail otevírá pod sbaleným přepínačem webů; otevření seznamu detail zavře. Obsah detailů zůstává zachovaný a delší obsah má vlastní scroll.
