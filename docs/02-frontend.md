...
- **Panel webů ve variantě 2:** výchozí ukázka má dva skenované weby, hledání podle domény/názvu a kapacitu „2 ze 3 webů“. Řádky oddělují načtené stránky a známé URL; v ukázkových datech jsou načtené stránky odvozené ze zdrojů vazeb. Pauza počty neskrývá. „Přidat web“ doplní třetí web do stejné místní mapy se zachováním výsledků a nastavení; validuje adresu a duplicitu, v archivu a při plné kapacitě je zakázané. „Nová mapa“ zůstává samostatnou akcí v záhlaví.
