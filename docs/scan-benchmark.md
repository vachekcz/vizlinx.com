...
Aktuální aplikace si ponechává své limity 3 originů, 50 stránek na origin a globální limity prototypu. Kapacitní model je nezvyšuje a nepřidává do aplikace serverové skenování.
